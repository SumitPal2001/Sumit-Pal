...
<html>
    <head>
        ...
        <style>
            ...
            box-shadow: 0px 0px 12px 7px rgba(255, 165, 150, 0.8) inset;
            ...
            <div class="row">
                <div class="jumbotron" style="box-shadow: 2px 2px 4px #000000;">
                    <div class="box"> 
                        ...
                        <h2 class="text-center">YOUR PAYMENTS HAS BEEN Failed</h2>
                    <h3 class="text-center"></h3>
                    
                    <!--<p class="text-center">Your MarchTransaction ID: <?php echo $_GET['transactionId']; ?></p>-->
                    <p class="text-center">Your Transaction ID: <?php echo $_GET['referenceId']; ?></p>
                    ...
                    <!-- <p Class="text-center">If Any Querry Contact us</p> -->
                    <center>
